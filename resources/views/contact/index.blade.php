...
@section('header')
    <div class="flex justify-between">
        ...
        <a href="{{ route('contacts.create') }}"
            class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Create
            a Contact</a>
    </div>
@endsection
...
@section('content')
    <div class="rounded-xl bg-white p-5 mb-5">
        <form class="flex">
            ...
            <button type="submit"
                class="self-end rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Filter</button>
        </form>
    </div>
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    @if($contacts->isEmpty())
                        <tr class="hover:bg-gray-50" >
                            <td colspan="5" class="whitespace-nowrap px-6 py-4 text-sm font-medium text-gray-900">
                                No contacts have been found
                            </td>
                        </tr>
                    @endif
